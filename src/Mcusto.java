public class Mcusto {
    ...
    public double[][] nTCUSTO;
    public double[][] recebe1F1_F2_CUSTO;
    public double[][] recebe2F1_F2_CUSTO;
    public double[][] recebe3F1_F2_CUSTO;
    public double[][] transfere1F1_F2_CUSTO;
    public double[][] transfere2F1_F2_CUSTO;
    public double[][] transfere3F1_F2_CUSTO;
    ...
    private double[][] shiftTransfereX(double[][] nt,int x){
        ...
        addTransferfee(transferex,x);

        return transferex;
    }


    private void addTransferfee(double[][] nt,int transfernumb) {
        double[][] matrix = new double[13][13];
        int maxcols = 13 - transfernumb;
        for (int i = 0; i < 13; i++) { // faz a natrix td
    ...
    public double[][] getMatrizCusto(int i){
        if(i == 0){
            return this.nTCUSTO;
        }else if(i == 1){
            return this.recebe1F1_F2_CUSTO;
        }else if(i == 2){
            return this.recebe2F1_F2_CUSTO;
        }else if(i == 3){
            return this.recebe3F1_F2_CUSTO;
        }else if(i == 4){
            return this.transfere1F1_F2_CUSTO;
        }else if(i == 5){
            return this.transfere2F1_F2_CUSTO;
        }else if(i == 6){
            return this.transfere3F1_F2_CUSTO;
        }
    ...
    public Mcusto(){
        ...
        this.nTCUSTO = multiplyMatrix(nTF1,nTF2);
        ...
        double[][] transfere2F1 = shiftTransfereX(transfere1F1,2);
        double[][] transfere3F1 = shiftTransfereX(transfere2F1,3);
        ...
        double[][] transfere2F2 = shiftTransfereX(transfere1F2,2);
        double[][] transfere3F2 = shiftTransfereX(transfere2F2,3);

        // FILIAL 1   FILIAL 2
        //
        // recebe 1 transfere 1 -- Verified
        this.recebe1F1_F2_CUSTO= multiplyMatrix(recebe1F1,transfere1F2);

        // recebe 2 transfere 2 -- Verified
        this.recebe2F1_F2_CUSTO= multiplyMatrix(recebe2F1,transfere2F2);

        // recebe 3 transfere 3 -- Verified
        this.recebe3F1_F2_CUSTO= multiplyMatrix(recebe3F1,transfere3F2);

        // transfere 1 recebe 1 -- Verified
        this.transfere1F1_F2_CUSTO= multiplyMatrix(transfere1F1,recebe1F2);

        // transfere 2 recebe 2 -- Verified
        this.transfere2F1_F2_CUSTO= multiplyMatrix(transfere2F1,recebe2F2);

        // transfere 3 recebe 3 -- Verified
        this.transfere3F1_F2_CUSTO= multiplyMatrix(transfere3F1,recebe3F2);
        //printMatrix(nTF1,13,13);
